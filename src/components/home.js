export default function Landing() {
  ...
  <div className="notetext">
    <p className="homelist">
      01/2025: Many thanks to NSF for supporting our research on Automated Testing of Augmented Reality Apps!!  <br />
